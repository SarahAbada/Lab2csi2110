public class TryStack2 {
  ...
  public TryStack2(int n, LinkedStack<Integer> stack) { //to linkedstack and changed most of TryStack1 to 2
    setArray(n);
    this.stack = stack;
  }
  ...
  public void setStack(int n) {
    stack = new LinkedStack<Integer>(); //to linkedstack and generi
  }
  ...
  public static void main(String[] args) {
    ...
    TryStack2 tryStack = new TryStack2(n, new LinkedStack<Integer>()); //to linkedstack
